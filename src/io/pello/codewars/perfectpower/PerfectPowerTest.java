...
public class PerfectPowerTest {
  ...
  @Test
  public void test10() {
    assertArrayEquals("16 = 4^2", new int[]{4,2}, PerfectPower.isPerfectPower(16));
  }
  
  @Test
  public void test11() {
      int []r = PerfectPower.isPerfectPower(256);
      assertEquals("256 = 4^4", ipow(r[0], r[1])  , 256);
  }
  
  @Test
  public void test12() {
      int []r = PerfectPower.isPerfectPower(484);
      assertEquals("484", ipow(r[0], r[1])  , 484);
  }
